...
from apps.curation.services.telegram_message_builder import CAPTION_MAX
...
class PublishTelegramAICurationTests(TestCase):
    ...
    def _create_ready_batch(self, *, caption='Caption <b>curada</b> Telegram', local_image_path=''):
        ...
        CuratedBatchItem.objects.create(
            ...
            final_caption_whatsapp='Caption WhatsApp curada',
    ...
    def test_dry_run_ai_curation_prints_ready_batch_with_curated_caption_and_image_without_delivery(self):
        batch = self._create_ready_batch(local_image_path='media/curation/local-final.jpg')
        out = StringIO()
        ...
        self.assertIn('Caption &lt;b&gt;curada&lt;/b&gt; Telegram', text)
